<div>
	<form method="post" class="form form-horizontal validform" action="${"$"}{ctx.contextPath}/${config.prefix}/${table.javaNameL}/${"$"}{${table.javaNameL}.id}">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-6">
				<input class="input-text" name="${column.javaName}" value="${"$"}{${table.javaNameL}.${column.javaName}!}" />
			</div>
